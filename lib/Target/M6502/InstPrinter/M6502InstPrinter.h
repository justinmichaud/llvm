//=== M6502InstPrinter.h - Convert M6502 MCInst to assembly syntax -*- C++ -*-==//
//
...
//===----------------------------------------------------------------------===//
//
// This class prints a M6502 MCInst to a .s file.
//
//===----------------------------------------------------------------------===//
...
namespace llvm {
// These enumeration declarations were originally in M6502InstrInfo.h but
// had to be moved here to avoid circular dependencies between
// LLVMM6502CodeGen and LLVMM6502AsmPrinter.
namespace M6502 {
// M6502 Branch Codes
enum FPBranchCode {
  BRANCH_F,
...
const char *M6502FCCToString(M6502::CondCode CC);
} // end namespace M6502
