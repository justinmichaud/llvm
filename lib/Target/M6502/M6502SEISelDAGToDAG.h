//===-- M6502SEISelDAGToDAG.h - A Dag to Dag Inst Selector for M6502SE -----===//
//
...
#ifndef LLVM_LIB_TARGET_M6502_M6502SEISELDAGTODAG_H
#define LLVM_LIB_TARGET_M6502_M6502SEISELDAGTODAG_H

#include "M6502ISelDAGToDAG.h"

namespace llvm {

class M6502SEDAGToDAGISel : public M6502DAGToDAGISel {

public:
  explicit M6502SEDAGToDAGISel(M6502TargetMachine &TM, CodeGenOpt::Level OL)
...
FunctionPass *createM6502SEISelDag(M6502TargetMachine &TM,
