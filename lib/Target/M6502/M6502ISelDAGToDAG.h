//===---- M6502ISelDAGToDAG.h - A Dag to Dag Inst Selector for M6502 --------===//
//
...
#ifndef LLVM_LIB_TARGET_M6502_M6502ISELDAGTODAG_H
#define LLVM_LIB_TARGET_M6502_M6502ISELDAGTODAG_H
...
public:
  explicit M6502DAGToDAGISel(M6502TargetMachine &TM, CodeGenOpt::Level OL)
...
protected:
  ...
  /// Keep a pointer to the M6502Subtarget around so that we can make the right
